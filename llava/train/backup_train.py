...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        # test_input_ids = deepcopy(data_dict['input_ids'][0])
        # [self.tokenizer.convert_ids_to_tokens(token) if token != -200 else "__IMAGE__" for token in test_input_ids.tolist()]
